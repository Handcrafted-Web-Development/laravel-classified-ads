    ...
    <div class="max-w-7xl mx-auto p-6 lg:p-8">
        ...
        <div class="mt-4">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                ...
                @foreach($ads as $ad)
                    <x-nav-link class="scale-100 p-6 bg-white from-gray-700/50 via-transparent rounded-lg shadow-2xl shadow-gray-500/20 flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500"
                        :href="route('ad', $ad->id)" :active="request()->routeIs('ad')">
                        <div>
                            <div class="h-16 w-16 bg-red-50 flex items-center justify-center rounded-full">
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-900">{{ $ad->title }}</h2>
                            <p class="mt-4 text-gray-500 text-sm leading-relaxed">{{ $ad->description }}</p>
                        </div>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                             class="self-center shrink-0 stroke-red-500 w-6 h-6 mx-6">
                            <path stroke-linecap="round" stroke-linejoin="round"
